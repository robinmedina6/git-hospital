                            ...
                            <table>
                              <tr>
                                <th>
                                  ...
                                  <center data-parsed=""> <img src="<?=base_url('assets/img/hospital.webp')?>" align="center" class="float-center"> </center>
                                  <table class="spacer">
                                    <tbody>
                                      <tr>
                                        <td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td>
                                  ...
                                  <p>Los datos con los que quedo registrada la cuenta</p>
                                  <p>email:<strong><?=$correo?></strong></p>
                                  <p>rango:<strong><?=$range?></strong></p>
                                  <p>contrasela:<strong><?=$contrasena?></strong></p>
                                  <br />
                                  <p>resguarda estos datos , Son intransferibles</p>}
                                  <a href="<?=base_url('/index.php/login')?>">ir al login</a>
                                  <center data-parsed="">
